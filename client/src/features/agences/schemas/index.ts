...
export const agenceQuerySchema = z.object({
  ...
  actif: z
    ...
    .optional(),
  sortBy: z.enum(['nom', 'code', 'createdAt', 'updatedAt']).default('createdAt'),
  sortOrder: z.enum(['asc', 'desc']).default('desc'),
})

export const createAgenceSchema = z.object({
  nom: z.string().trim().min(2, "Le nom de l'agence doit contenir au moins 2 caractères"),
  code: z
    .string()
    .trim()
...
export type CreateAgenceFormValues = z.infer<typeof createAgenceSchema>
export type UpdateAgenceFormValues = z.infer<typeof updateAgenceSchema>
