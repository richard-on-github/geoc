...
interface AbattementPeriodeControlsProps {
  annee: number
...
export function AbattementPeriodeControls({
  annee,
  mois,
  onChangeAnnee,
  onChangeMois,
}: AbattementPeriodeControlsProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <div className="flex items-center gap-2">
        <label
          htmlFor="abattement-periode-annee"
          className="text-xs font-medium text-[hsl(var(--muted-foreground))]"
        >
          Année
        </label>
        <select
          id="abattement-periode-annee"
          value={annee}
          onChange={(e) => {
      ...
      {mois !== undefined && onChangeMois && (
        <div className="flex items-center gap-2">
          <label
            htmlFor="abattement-periode-mois"
            className="text-xs font-medium text-[hsl(var(--muted-foreground))]"
          >
            Mois
          </label>
          <select
            id="abattement-periode-mois"
            value={mois}
            onChange={(e) => {
