...
export function DeleteUserDialog({ user, onClose }: DeleteUserDialogProps) {
  ...
  return (
    <div role="alertdialog" aria-modal="true" aria-labelledby="delete-user-title"
      ...
      <div className="relative z-10 w-full max-w-sm rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-lg p-6">
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <div>
            <h2 id="delete-user-title" className="text-base font-semibold">Supprimer l'utilisateur</h2>
            <p className="mt-1.5 text-sm text-[hsl(var(--muted-foreground))]">
              Voulez-vous vraiment supprimer <span className="font-medium text-[hsl(var(--foreground))]">{user.fullName}</span> ?
