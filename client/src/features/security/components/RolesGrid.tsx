...
export function RolesGrid({ onEdit, onDelete }: RolesGridProps) {
    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {rolesList.map((role: any) => {
        ...
        return (
          <div
            key={role.id}
            className="group rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-5 transition-shadow hover:shadow-sm"
          >
            {/* Header */}
