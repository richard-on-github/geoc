...
export const roleService = {
  ...
  async getRolePermissions(roleId: string) {
    ...
    const relations = await roleRepository.findPermissions(roleId);
  ...
  async addRolePermissions(
    ...
    await logAudit({
      ...
      userId: actorId,
      ip: ip ?? "",
      message: `Permissions ajoutées au rôle ${role.code}`,
  ...
  async deleteRolePermission(
    ...
    await roleRepository.deletePermission(roleId, permissionId);
    ...
    await logAudit({
      ...
      userId: actorId,
      ip: ip ?? "",
      message: `Permission retirée du rôle ${role.code}`,
