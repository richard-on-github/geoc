...
export const permissionsData: readonly PermissionItem[] = [
  ...
  },
  {
    ...
    description:
      "Permet de lister et de consulter les profils des utilisateurs.",
  },
  {
    code: "user.update",
    nom: "Modifier un utilisateur",
    description:
      "Permet de modifier les informations et paramètres d'un utilisateur.",
  },
  {
    code: "user.delete",
    nom: "Supprimer un utilisateur",
    description:
      "Permet de supprimer ou de désactiver le compte d'un utilisateur.",
  },
  ...
  },
  {
    ...
    description:
      "Permet de modifier les droits et habilitations attribués à un rôle.",
  },
  {
    code: "role.delete",
...

  {
    ...
    description:
      "Permet de consulter les traces d'audit et l'historique des actions du système.",
  },
  ...
  },
  {
    ...
    description:
      "Permet de consulter la liste et les informations des agences.",
  },
  {
    code: "agence.update",
    nom: "Modifier une agence",
    description:
      "Permet de modifier les configurations et informations d'une agence.",
  },
  {
    code: "agence.delete",
...

  {
    ...
    description:
      "Permet de consulter le catalogue et l'historique détaillé des ventes.",
  },
  {
    code: "vente.import",
...

  {
    ...
    description:
      "Permet de générer des rapports d'export des ventes au format CSV.",
  },
  {
    code: "vente.export.excel",
    nom: "Exporter les ventes (Excel)",
    description:
      "Permet de générer des rapports d'export des ventes au format Excel.",
  },
  {
    code: "vente.export.pdf",
    nom: "Exporter les ventes (PDF)",
    description:
      "Permet de générer des rapports d'export des ventes au format PDF.",
  },
  {
    code: "dashboard.read",
    nom: "Consulter le tableau de bord",
    description:
      "Permet de consulter le tableau de bord et ses indicateurs de performance.",
  },
  {
    code: "vente.email.manage",
    nom: "Gérer les emails autorisés",
    description:
...
export async function seedPermissions(): Promise<void> {
  console.log(
    `Début de la synchronisation de ${permissionsData.length} permissions...`,
  );
